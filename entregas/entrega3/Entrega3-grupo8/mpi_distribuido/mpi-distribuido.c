...
void matrizFibonacci(unsigned long long * resultadosFib, int * F, double * FibF, int n, int * min, int * max, int * suma, int porcion) {
  int valor, i, j;
...
int main(int argc, char *argv[]){
  ...
  matrizFibonacci(resultadosFib, F, FibF, n, &min, &max, &suma, porcion);
